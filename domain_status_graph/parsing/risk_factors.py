...
from domain_status_graph.parsing.text_extraction import extract_text_between_elements
...
def extract_risk_factors_with_datamule_fallback(
    ...
    try:
        from domain_status_graph.utils.datamule import get_cached_parsed_doc
