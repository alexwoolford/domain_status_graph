...
from domain_status_graph.config import get_openai_api_key
from domain_status_graph.constants import EMBEDDING_MODEL
...
def create_embedding(
    ...
    if use_chunking:
        from domain_status_graph.embeddings.chunking import create_embedding_with_chunking
